...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(CombatTag_Attack_Melee_Heavy, "Combat.Attack.Melee.Heavy", "Heavy melee attack that can force a stagger reaction.");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(CombatTag_EnemyStateReason_PursuitResumed, "Combat.Enemy.StateReason.PursuitResumed", "The target moved outside the contact-distance hysteresis.");
...
UE_DEFINE_GAMEPLAY_TAG_COMMENT(CombatTag_EnemyStateReason_AttackReady, "Combat.Enemy.StateReason.AttackReady", "The basic enemy established valid capsule contact with its target.");
